...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("dgley"))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("dgley@email.com"))
